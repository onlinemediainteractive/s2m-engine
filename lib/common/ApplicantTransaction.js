...
ApplicantTransaction.prototype.getFirstName = function() {
    ...
    var firstName = this.applicantCreation.serviceResponse.params.firstName || 'UNKNOWN';
...
ApplicantTransaction.prototype.getParams = function() {
    ...
    return this.applicantCreation.serviceResponse.params;
...
ApplicantTransaction.prototype.getLastName = function() {
    ...
    var lastName = this.applicantCreation.serviceResponse.params.lastName || 'UNKNOWN';
