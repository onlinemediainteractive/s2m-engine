...
function ApplicantTransaction(options) {
    ...
    //if(!_.isNil(opts.criminalBackgroundVerification)) {
    //    this.criminalBackgroundVerification                = JSON.parse(encrypt.decryptDbString(opts.criminal_background_verification));
    //} else {
    //    this.criminalBackgroundVerification                = undefined;
    //};
    ...
    //this.criminalBackgroundStatus           = opts.criminalBackgroundStatus                 || undefined;
   ...
   // this.facebookVerificationStatus         = opts.facebook_verification_status            || undefined;
    ...
    this.criminalSource                  = opts.national_criminal_verification_source                 || 'onfido';
    this.sexOffenderSource                  = opts.sex_offender_verification_source                 || 'onfido'
...
ApplicantTransaction.prototype.clear = function() {
    ...
    //this.criminalBackgroundStatus = undefined;
    //this.criminalBackgroundVerification = undefined;

    this.verifications                      = 0;
    this.activities                         = 0;
    this.criminalSource                     = undefined;
    this.sexOffenderSource                  = undefined;
...
ApplicantTransaction.prototype.getFirstName = function() {

    var firstName = this.applicantCreation.params.firstName || 'UNKNOWN';

    return firstName;

};

ApplicantTransaction.prototype.getParams = function() {


    return this.applicantCreation.params;

};

ApplicantTransaction.prototype.getLastName = function() {


    var lastName = this.applicantCreation.params.lastName || 'UNKNOWN';
...
//ApplicantTransaction.prototype.setCriminalBackgroundStatus = function(status) {
//    this.criminalBackgroundStatus = status;
//}


//ApplicantTransaction.prototype.setCriminalBackgroundVerification= function(criminalBackgroundVerification) {

//    this.criminalBackgroundVerification = criminalBackgroundVerification;
//};


ApplicantTransaction.prototype.setCriminalSource = function(source) {

    this.criminalSource = source;
};

ApplicantTransaction.prototype.getCriminalSource = function() {

    return this.criminalSource;
};


ApplicantTransaction.prototype.setSexOffenderSource = function(source) {

    this.sexOffenderSource = source;
};

ApplicantTransaction.prototype.getSexOffenderSource = function() {

    return this.sexOffenderSource
};
