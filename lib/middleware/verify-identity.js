...
getQuestions = function(req) {
    ...
    var soapBodyStr = JSON.stringify(soapBody);

    soapBodyStr = soapBodyStr.replace(noDashSsn,'***-**-****');
    //soapBodyMask.

    //logger.debug('soapBody : ' + soapBody);
    logger.debug('soapBody : ' + soapBodyStr);
    var options = {};
