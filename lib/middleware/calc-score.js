    ...
    return using(
        ...
        try {
            ...
            (facebook == 1)
            {
                ...
                debug('facebook  first name check - ' +  scoreTrace.facebookFirstName + ' = ' +  applicantTransaction.getFirstName());
                if (scoreTrace.facebookFirstName == applicantTransaction.getFirstName()) {
                    fmfnMatch = true;
                }
                debug('facebook last name check - ' +  scoreTrace.facebookLastName + ' = ' +  applicantTransaction.getLastName());
