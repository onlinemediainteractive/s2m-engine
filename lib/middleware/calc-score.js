    ...
    return using(
        ...
        try {
            ...
            (facebook == 1)
            {
                var fmfnMatch = false;
                var fmlnMatch = false;
                if (facebookFirstName == applicantTransaction.getFirstName()) {
                    fmfnMatch = true;
                }
                if (facebookLastName == applicantTransaction.getLastName()) {
                    fmlnMatch = true;
                }
