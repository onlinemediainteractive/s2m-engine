...
module.exports = function (req, res, next) {
    ...
    if(onfidoConfig.active == false) {
    ...
    else if ((req.applicantTransaction.nationalCriminalVerificationRequired()) || (req.subscribeReq ==  "yes")) {
        ...
        onfido.getReport(req.applicantTransaction.getHrefId(), 'national_criminal').then(function(response) {
            ...
            db.makeVerificationBackup(req.applicantTransaction.getId(), req.subscribeReq).then(function(insertResult) {
                ...
                db.saveVerificationStepStatus(req.applicantTransaction.getId(), nationalCriminalVerificationJSON, responseStatus, 'national_criminal_verification','onfido').then(function(result) {
                    if(!_.isNil(result)) {
                        ...
                        req.applicantTransaction.setCriminalSource('onfido')
